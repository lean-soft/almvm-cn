...
SET PATH=%PATH%;C:\home\site\deployments\tools\r\ruby-2.3.1-x64-mingw32\bin

REM I am in the repository folder
pushd C:\home\site\deployments
...
SetLocal DisableDelayedExpansion & C:\Tools\7-zip\7z x -xr!*.ri -y ruby231.zip > rubyout
...
C:\Tools\7-zip\7z x -y -oDevKit DevKit.zip > devkitout
...
echo --- > config.yml
echo - C:/home/site/deployments/tools/r/ruby-2.3.1-x64-mingw32 >> config.yml
